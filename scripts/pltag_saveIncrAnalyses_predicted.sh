...
incrAnalysesFeaturesPath=${execDir}/incrAnalysesFeatures_wsj_0221_${outputSuffix}
# the path the dictionaries for the various features extracted
discriminativeFeatureIndexers=${execDir}/featureIndexers_${outputSuffix}
...
extendIndexers=false

# iSRL - Lexicon model type: set to 'oracle' in order to use gold standard lexicon entries for the
# input examples and gold standard oracle semantic role labels (oracle features), set to 'parsedAllRoles' (DEFAULT)
